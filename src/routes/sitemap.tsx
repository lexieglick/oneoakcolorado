...
const lots: LotData[] = [
  ...
  { id: "b1-2",  block: "B1", number: 2,  name: "Durango",     status: "available",  acres: "0.52 ac", SQF: "22,980 ft²",  path: "" },
  ...
  { id: "b1-5",  block: "B1", number: 5,  name: "Keystone",      status: "available",      acres: "0.59 ac", SQF: "25,825 ft²",  path: "" },
  ...
  { id: "b1-11", block: "B1", number: 11, name: "Dillon",        status: "available",  acres: "0.47 ac", SQF: "20,766 ft²",  path: "" },
  { id: "b1-12", block: "B1", number: 12, name: "Georgetown",    status: "available", acres: "0.42 ac", SQF: "18,692 ft²",  path: "" },
  { id: "b1-13", block: "B1", number: 13, name: "The Springs", status: "available", acres: "0.48 ac", SQF: "21,259 ft²",  path: "" },
  { id: "b1-14", block: "B1", number: 14, name: "Fairplay",      status: "available", acres: "0.61 ac", SQF: "26,975 ft²",  path: "" },
  { id: "b1-15", block: "B1", number: 15, name: "Alma",          status: "available",      acres: "0.61 ac", SQF: "26,922 ft²",  path: "" },
  // B2
  ...
  { id: "b2-3",  block: "B2", number: 3,  name: "Ouray",         status: "available",  acres: "0.41 ac", SQF: "18,170 ft²",  path: "" },
  ...
  { id: "b2-6",  block: "B2", number: 6,  name: "Salida",        status: "available",      acres: "0.61 ac", SQF: "26,827 ft²",  path: "" },
